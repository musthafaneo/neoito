...
<div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>">
    ...
    <div class="testi-block-head">
        <?php if($title){?>
            <h2 class="section-title block lg:hidden" data-aos="fade-up"><?php echo $title;?></h2>
        <?php }?>
    </div><!-- .testi-block-head -->   
                ...
                <div class="carousel-main">
                    <div class="home-testimonials-cl-content">
                        ...
                        <div class="home-testimonials-cl-content-item">
                            <?php if($title){?>
                                <h2 class="section-title hidden lg:block" data-aos="cs-text"><?php echo $title;?></h2>
                            <?php }?>
